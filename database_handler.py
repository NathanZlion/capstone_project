...
class DB_Handler:
    ...
    def get_driver_ratings(self, driver_id: int) -> List[Rating]:
        try:
            self._cursor.execute(
                f"""
